    ...
    <section className="why-choose-us-section w-full xl:p-20 sm:py-12 sm:px-12 p-5 flex flex-col gap-8 justify-center items-center ">
      ...
      <div className="points-main w-full flex sm:justify-between justify-center flex-wrap">
        ...
        <div className="GUARENTEE points-cards flex flex-col items-center justify-center p-[0.75rem] gap-3">
          ...
          <div className="cards-content flex flex-col text-center gap-3">
            <h3 className="text-[#121212] text-[19px]">Guarantee</h3>
            <p className="sm:max-w-[13rem] text-[1rem] text-[#121212]">
